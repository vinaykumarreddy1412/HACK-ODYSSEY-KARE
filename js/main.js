/**
 * HACK ODYSSEY 4.0 - INTERACTIVE CORE LOGIC (DARK CYBER PURPLE THEME)
 * Kalasalingam Academy of Research and Education | Euphoria 2026
 * Target UI/UX Replica: https://hackodyssey40.vercel.app/
 */
...
function initDynamicContent() {
  ...
  if (sdgGrid && cfg.sdgs) {
    sdgGrid.innerHTML = cfg.sdgs.map(sdg => `
      <div class="sdg-card-item reveal-on-scroll">
        <span class="sdg-num-badge">${sdg.number}</span>
...
/* ==========================================================================
   6. NAVIGATION & MOBILE DRAWER LOGIC
   ========================================================================== */
  ...
  document.querySelectorAll('a[href^="#"]').forEach((anchor) => {
    anchor.addEventListener('click', function (e) {
      ...
      if (targetEl) {
        ...
        const offsetPosition = targetEl.offsetTop - 90;
        window.scrollTo({
          top: offsetPosition,
          behavior: 'smooth',
        });
